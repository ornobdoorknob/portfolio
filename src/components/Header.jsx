...
<body class="bg-gray-100">
    ...
    <a href="#" class="flex items-center font-oswald">
        ...
        <a href="#contact" class="font-poppins md:hidden block bg-black border-green-400 border-2 hover:bg-green-500 hover:text-black text-white px-6 py-3 rounded-full transition-all duration-300">Contact</a>
    </header>
</body>
    )
}
